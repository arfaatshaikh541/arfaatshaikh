...
const NAV_ITEMS: { href: string; label: string; permission?: string; module?: string }[] = [
  ...
  { href: "/scoring", label: "Scoring", permission: "scoring.manage", module: "crm" },
  { href: "/assignment", label: "Assignment", permission: "assignment.manage", module: "crm" },
  { href: "/communications", label: "Communications", permission: "communications.manage", module: "communications" },
  { href: "/appointments", label: "Appointments", permission: "appointments.view", module: "booking" },
