...
export default function OperatorDetailPage({ params }: { params: Promise<{ operatorId: string }> }) {
  ...
  return (
    <main id="main-content" className="mx-auto w-full max-w-3xl flex-1 p-4 sm:p-8">
      ...
      <Link href={`/dashboard/operator/${operatorId}/assurance`} className="mb-2 inline-block text-sm underline">
        Service assurance &rarr;
      </Link>
      <Link href={`/dashboard/operator/${operatorId}/billing`} className="mb-6 inline-block text-sm underline">
