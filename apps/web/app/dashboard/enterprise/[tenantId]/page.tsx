  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 p-8">
      ...
      <section className="mb-8 flex flex-col gap-1">
        ...
        <Link href={`/dashboard/enterprise/${tenantId}/placement`} className="text-sm underline">
          Capacity &amp; placement &rarr;
        </Link>
        <Link href={`/dashboard/enterprise/${tenantId}/deployments`} className="text-sm underline">
          Deployments &rarr;
        </Link>
        ...
        <Link href={`/dashboard/enterprise/${tenantId}/billing`} className="text-sm underline">
          Usage, billing &amp; settlement &rarr;
        </Link>
      </section>
