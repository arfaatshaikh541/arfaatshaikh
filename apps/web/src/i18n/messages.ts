...
const messages = {
  en: {
    ...
    displayName: "Display name", forgotPassword: "Forgot password?", dashboard: "Foundation dashboard",
  ...
  ar: {
    ...
    displayName: "الاسم الظاهر", forgotPassword: "نسيت كلمة المرور؟", dashboard: "لوحة التأسيس",
