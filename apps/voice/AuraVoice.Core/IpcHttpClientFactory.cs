...
/// rationale. Everything above the transport (HttpWakeWordDetector,
/// HttpSpeechToText, HttpTextToSpeech's request/response code) is
/// completely unaware this isn't a normal TCP connection.
/// </summary>
