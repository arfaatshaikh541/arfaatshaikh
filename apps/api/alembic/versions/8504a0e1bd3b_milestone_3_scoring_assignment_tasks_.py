...
down_revision: str | None = "c1bf0520626a"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_scoring_rules_tenant_id"), "scoring_rules", ["tenant_id"], unique=False
    )
    op.create_table(
        "task_types",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["fallback_membership_id"], ["memberships.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_assignment_rules_tenant_id"), "assignment_rules", ["tenant_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_tasks_assigned_membership_id"), "tasks", ["assigned_membership_id"], unique=False
    )
