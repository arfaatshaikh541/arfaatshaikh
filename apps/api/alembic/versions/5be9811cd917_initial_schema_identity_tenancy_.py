...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["feature_id"],
            ["features.id"],
            name=op.f("fk_add_ons_feature_id_features"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_credit_wallets_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_credit_wallets_tenant_id"), "credit_wallets", ["tenant_id"], unique=True
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["feature_id"],
            ["features.id"],
            name=op.f("fk_feature_overrides_feature_id_features"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["granted_by_user_id"],
            ["users.id"],
            name=op.f("fk_feature_overrides_granted_by_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_feature_overrides_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_feature_overrides")),
    )
    op.create_index(
        op.f("ix_feature_overrides_tenant_id"), "feature_overrides", ["tenant_id"], unique=False
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["granted_by_user_id"],
            ["users.id"],
            name=op.f("fk_support_access_grants_granted_by_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["platform_user_id"],
            ["users.id"],
            name=op.f("fk_support_access_grants_platform_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_support_access_grants_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_support_access_grants")),
    )
    op.create_index(
        op.f("ix_support_access_grants_platform_user_id"),
        "support_access_grants",
        ["platform_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_support_access_grants_tenant_id"),
        "support_access_grants",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["metric_id"],
            ["usage_metrics.id"],
            name=op.f("fk_usage_records_metric_id_usage_metrics"),
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
    ...
    op.create_index(
        op.f("ix_credit_reservations_tenant_id"), "credit_reservations", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_credit_reservations_wallet_id"), "credit_reservations", ["wallet_id"], unique=False
    )
    op.create_table(
        "invitations",
        sa.Column("tenant_id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["add_on_id"], ["add_ons.id"], name=op.f("fk_tenant_add_ons_add_on_id_add_ons")
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            name=op.f("fk_tenant_add_ons_tenant_id_tenants"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_tenant_add_ons")),
    )
    op.create_index(
        op.f("ix_tenant_add_ons_tenant_id"), "tenant_add_ons", ["tenant_id"], unique=False
    )
    op.create_table(
        "credit_transactions",
        sa.Column("tenant_id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["created_by_user_id"],
            ["users.id"],
            name=op.f("fk_credit_transactions_created_by_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["reservation_id"],
            ["credit_reservations.id"],
            name=op.f("fk_credit_transactions_reservation_id_credit_reservations"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id", "wallet_id"],
    ...
    op.create_index(
        op.f("ix_credit_transactions_tenant_id"), "credit_transactions", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_credit_transactions_wallet_id"), "credit_transactions", ["wallet_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_support_access_grants_platform_user_id"), table_name="support_access_grants"
    )
